...
export function AboutPanel({ onClose }: AboutPanelProps) {
  ...
  return (
    <div
      ref={ref}
      className="absolute right-2 left-2 top-14 z-10 max-h-[80vh] overflow-auto rounded-lg border border-stone-200 bg-[var(--paper-bg)] p-4 shadow-lg sm:left-auto sm:right-4 sm:w-80 dark:border-neutral-800 dark:bg-neutral-900"
    >
